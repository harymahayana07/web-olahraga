    ...
    <div id ="wrapper">
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <a href="">
                  <img src="../assets/img/logo_web-gym.jpg" style="height: 40px; width:40px"  
                  alt="hary_gym" class="brand-image img-circle elevation-3" style="opacity: .8" >
                ...
                <img src="../assets/img/avatar.png" style="height: 20px; width:20px"  
                alt="hary_gym" class="brand-image img-circle elevation-3" style="opacity: .8" >
                ...
                <li>
                    <a href="poliklinik/data.php">Data Transaksi</a>
                </li>
                <li>
